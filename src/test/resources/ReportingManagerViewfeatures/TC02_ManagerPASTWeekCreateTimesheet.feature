Feature: Manager Able To Create Timesheet For Previous Week
 
	Background:
			Given User Can Able To Login Into The Manager View For Create Timesheet
  @ManagerView
	 Scenario Outline:Manager Able To Create Timesheet For Previous Week
	
     And Click On Create Timesheet Icon In Manager View
     And Select the Previous Date In Manager View From Calender Icon
