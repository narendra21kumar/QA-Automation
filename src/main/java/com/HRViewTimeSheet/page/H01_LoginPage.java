package com.HRViewTimeSheet.page;
...
//	private static By unsafeURL_locater = By.xpath("//body[@id='body']");
	...
	public H01_LoginPage(WebDriver driver) {
		this.driver = driver;
	...
	private void getUsername() {
		String username = ConfigReader.getHrUsername();
	...
	private void getPassword() {
		String password = ConfigReader.getHrPassword();
