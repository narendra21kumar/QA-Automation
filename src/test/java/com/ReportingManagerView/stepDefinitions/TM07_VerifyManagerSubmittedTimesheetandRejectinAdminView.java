...
public class TM07_VerifyManagerSubmittedTimesheetandRejectinAdminView {
	...
	public void verify_the_manager_submitted_timesheet_and_reject_from_admin_view() {
		Logs.initLogs(TM07_VerifyManagerSubmittedTimesheetandRejectinAdminView.class.getName());
		Logs.startTestCase(this.getClass().getSimpleName());
		driver = WebDriverManager.getDriver();
		loginPage = new PM01_LoginPage(driver);
		verifyManagerSubmittedTimesheetandRejectinAdminViewPage = new PM07_VerifyManagerSubmittedTimesheetandRejectinAdminViewPage(
				driver);
