...
public class TC13_AdminReportsTestSteps {
	...
	@When("Click on Calendor Icon for Start Date")
	public void click_on_calendor_for_selection_of_Start_date() throws InterruptedException {
		adminReportsPage.clickOnCalendorStartIcon();
		CommonUtils.waitFor(3);
	}
	
	@Then("^Select Start Date$")
	public void select_start_date_for_previous_two_weeks() throws InterruptedException {
		adminReportsPage.selectAnyWeek(-2, Calendar.SUNDAY);
		CommonUtils.waitFor(3);
		//adminReportsPage.selectStartDateInCal();
	}
	
	@And("Click on Calendor for selection of End Date")
	public void click_on_calendor_for_selection_of_End_Date() throws InterruptedException {
		adminReportsPage.clickOnCalendorEndIcon();
		CommonUtils.waitFor(3);
	}
	
	@And("^Select End Date$")
	public void select_start_date_for_current_week() throws InterruptedException {
		adminReportsPage.selectAnyWeek(-1, Calendar.SATURDAY);
		CommonUtils.waitFor(3);
