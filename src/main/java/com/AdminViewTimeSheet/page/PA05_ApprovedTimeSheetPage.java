...
//------------------------------------------------------------------------------------	
	public void timeSheetSubmitted() {
		...
		Logs.info("Clicked on Timesheet ManagementPage");
	}
...
//---------------------------------------------------------------------------------	
	...
	public void verifyApprovedEmployees() {
		for (WebElement List : listOfEmpIds) {
			...
			if (ListRetreived.equals(empid)) {
				...
				Logs.info("EmpId has been Verified In approved page");
				break;
			} else {
				System.out.println("Employee ID not matched");
				Logs.info("EmpId not matched");
			}
		}
	}
	...
	public void searchByName(String name) {
		...
		Logs.info("searched by name form searchBox");
	}
}
